#!/usr/bin/env python
#
# Git command to transform staged files according to a command that accepts
# file content on stdin and produces output on stdout. This command is useful
# in combination with `git add -p` which allows you to stage specific changes
# in a file. This command runs a formatter on the file with staged changes
# while ignoring unstaged changes.
#
